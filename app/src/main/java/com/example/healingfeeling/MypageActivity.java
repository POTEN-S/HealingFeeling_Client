                ...
                for(String date : dates){
                    ...
                    for (Map.Entry<Integer,String> entrySet : hashMap.entrySet()){
                        ...
                        if(entrySet.getKey()==arraycount) {
                            ...
                            }else if (entrySet.getValue().equals(null)){
                                events.add(new EventDay(calendar, R.drawable.question_mark, Color.parseColor("#000000")));
                            }
                        }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.logoutButton:
                    ...
                    MySharedPreference.clear_user(MypageActivity.this);
