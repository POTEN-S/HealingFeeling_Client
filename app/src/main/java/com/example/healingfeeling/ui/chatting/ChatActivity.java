...
//        textView.setSelected(true);
        ...
        String[] happy_sentence = {"여러분들이 생각하는 행복은 무엇인가요?                여러분들이 생각하는 행복은 무엇인가요?",
                "요즘 당신의 행복지수를 높여주는 것이 있나요?                         요즘 당신의 행복지수를 높여주는 것이 있나요? ",
                "올해가 가기전에 꼭 이루고 싶은것이 있나요?                          올해가 가기전에 꼭 이루고 싶은것이 있나요?",
                "오늘기분과 어울리거나 떠오르는 노래가 있나요?                         오늘기분과 어울리거나 떠오르는 노래가 있나요?",
        "행복을 의미하는 낱말들을 얘기해보세요.                        행복을 의미하는 낱말들을 얘기해보세요."};
        String[] sad_sentence = {"누구나 각자의 고민이 있어요. 고민을 털어놔 보세요!                        누구나 각자의 고민이 있어요. 고민을 털어놔 보세요!",
                "내가 슬플때 ___ 하면 힘날거같아!                                 내가 슬플때 ___ 하면 힘날거같아!",
                "당신이 힘들때 나오는 버릇이 있다면 무엇인가요?                       당신이 힘들때 나오는 버릇이 있다면 무엇인가요?",
                "일상이 지루해 질때 지루함에서 벗어나는 각자의 방법이 있나요?                  일상이 지루해 질때 지루함에서 벗어나는 각자의 방법이 있나요?",
        "요즘 당신의 상태 메세지를 한줄로 적어본다면?                                  요즘 당신의 상태 메세지를 한줄로 적어본다면?"};
        String[] angry_sentence = {"최근에 가장 기분나쁘거나 화가 났던일이 있었나요?                       최근에 가장 기분나쁘거나 화가 났던일이 있었나요?",
                "쓰레기통에 던져 버리고 싶은 기억이 있다면 무엇인가요?                             쓰레기통에 던져 버리고 싶은 기억이 있다면 무엇인가요?",
                "자신만의 분노를 해소하는 방법은?                                  자신만의 분노를 해소하는 방법은?"};
